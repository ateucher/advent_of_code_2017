...
The nature of the input appears to matter a lot as well. Here's my original implementation with my input
compared to @jennybc's [input](https://github.com/jennybc/2017_advent-of-code/blob/master/day06.R). 
The sequence of numbers that I was given as my input took many more iterations before a match occurred.
